<?php
    ...
    if(isset($_POST['login']))
    {
        ...
        if($count > 0)
        {
            ...
            {
                echo "<script type = \"text/javascript\">
                window.location = (\"superAdmin/teacherIndex.php\")
                </script>";  
            }
        }
        else
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="Post" Action="">
                            <?php echo $errorMsg; ?>
                               <strong><h2 align="center">Login</h2></strong><hr>
                        <div class="form-group">
                            <label>User ID</label>
                            <input type="text" name="staffId" Required class="form-control" placeholder="Staff ID" autofocus>
                        </div>
                        <div class="form-group">
