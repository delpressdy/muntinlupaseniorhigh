                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Section</label>
                                                        <input id="" name="departmentName" type="tel" class="form-control cc-cvc" value="" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="e.g Mercury,Venus">
                                                        </div>
                                                    </div>
                                                    <div>
