...
if(isset($_POST['submit'])){
  ...
  $query=mysqli_query($con,"insert into tblfaculty(facultyName,dateCreated) value('$facultyName','$dateCreated')");
    ...
    if ($query) {
      ...
      $statusMsg="Room Added Successfully!";
  }
  else
    {
      $alertStyle ="alert alert-danger";
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Add New Room</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="facultyName" type="tel" class="form-control cc-exp" value="" placeholder="e.g Room 1, Room 2">
                                                    </div>
                                                </div>
