...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"update tblcourse set courseTitle='$courseTitle',courseCode='$courseCode',courseUnit='$courseUnit',teacher='$teacher',facultyId='$facultyId', departmentId='$departmentId', levelId='$levelId',semesterId='$semesterId'
                                         ...
                                         <form method="Post" action="">
                                            <div class="row">
                                             ...
                                             <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="select" class=" form-control-label">Teacher</label>
                                                            <select required name="teacher" onchange="showLecturer(this.value)" class="custom-select form-control">
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $rowT['firstName'] .' '.$rowT['lastName'];?>"><?php echo $rowT['firstName'] .' '.$rowT['lastName'];?></option>
                                                                <?php  } ?>
                                                            </select>
                                                    </div>
                                                </div>
                                                <!-- <div class="col-6">
                                                    <div class="form-group">
                                                     <label for="x_card_code" class="control-label mb-1">Room Name</label>
                                                    <?php 
