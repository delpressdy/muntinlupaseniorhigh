                            ...
                            <div class="card-header">
                                <strong class="card-title">
                                    <?php 
                                        ...
                                        $g = $res['gradeLevel'];
                                     ?>
                                    <a href="enrollStudent.php?info=<?php echo $_SESSION['info'];?>&name=<?php echo $_SESSION['name']?>$g=<?php echo $g;?>" class="btn btn-success">Enroll</a>
                                ...
                                <table id="bootstrap-data-table" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>  <tr>
                                            ...
                                            <td><a style="color: red;" href="assignSub.php?info=<?php echo $_SESSION['info'];?>&name=<?php echo $_SESSION['name'];?>&glvl=<?php if($row2['levelName']=='Grade 11'){ echo 'Grade 11'; }else{ echo 'Grade 12';}?>"><?php echo 'Enrolled Subjects '?><i class="fa fa-eye"></i></a></td>
                                            </tr>
                                        <?php
                                        }?>
