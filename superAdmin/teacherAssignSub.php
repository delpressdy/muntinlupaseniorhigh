                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">
                                    <!-- <a href="teacherAddCourse.php?name=<?php echo $_SESSION['name'];?>&g=<?php echo $_GET['g'];?>&s=1" class="btn btn-info">Add 1st Semester</a>
                                    <a href="teacherAddCourse.php?name=<?php echo $_SESSION['name'];?>&g=<?php echo $_GET['g'];?>&s=2" class="btn btn-info">Add 2nd Semester</a> -->
                                    <h2 align="center">Enrolled Subject of the Student</h2>
                                </strong>
                            </div>
                            <div class="card-body">
                                <table 
