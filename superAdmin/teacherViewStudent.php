                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $sql=mysqli_query($con,"SELECT * from tblstudent WHERE teacher = '$name'");
                                            while ($row=mysqli_fetch_array($sql)) {
                                        ?>  <tr>
                                            <td><a class="stud-id" style="color:red;" href="teacherEditStudent.php?editStudentId=<?php echo $row['matricNo'];?>"><?php echo $row['matricNo'];?></a></td>
                                            ...
                                            <td><a style="color:red;" href="teacherStudentInfo.php?info=<?php echo $row['matricNo'];?>&name=<?php echo $row['firstName'] .' '. $row['lastName'] ?>">
